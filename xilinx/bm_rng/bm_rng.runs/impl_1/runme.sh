...
HD_PWD=/home/vxs9946/ee799/vxs9946_f2015/bm_rng/xilinx/bm_rng/bm_rng.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log bm_rng.vdi -applog -m64 -messageDb vivado.pb -mode batch -source bm_rng.tcl -notrace
